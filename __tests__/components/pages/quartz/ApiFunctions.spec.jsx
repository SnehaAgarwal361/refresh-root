...
test('Call Create Trigger API  function with expected argument list', () => {
  ...
  expect(mockApi)
    .toHaveBeenCalledWith('CreateKnowYourCustomerRefreshJobTrigger.v1', { defer: true, body: { application_name: 'Test Application', triggerName: 'Test Trigger' } });
});
...
test('Call Update Trigger API  function with expected argument list', () => {
  ...
  expect(mockApi)
    .toHaveBeenCalledWith('UpdateKnowYourCustomerRefreshJobTrigger.v1', { defer: true, body: { application_name: 'Test Application', triggerName: 'Test Trigger', schedule: { triggerType: 'CRON', interval: '0 0/2 * * * ?' } } });
});
...
test('Call Pause Trigger API  function with expected argument list', () => {
  ...
  expect(mockApi)
    .toHaveBeenCalledWith('UpdateKnowYourCustomerRefreshJobTrigger.v1', { defer: true, body: { application_name: 'Test Application', triggerName: 'Test Trigger', status: 'PAUSED' } });
});
...
test('Call Resume Trigger API  function with expected argument list', () => {
  ...
  expect(mockApi)
    .toHaveBeenCalledWith('UpdateKnowYourCustomerRefreshJobTrigger.v1', { defer: true, body: { application_name: 'Test Application', triggerName: 'Test Trigger', status: 'NORMAL' } });
});
...
test('Call Reset Trigger API  function with expected argument list', () => {
  ...
  expect(mockApi)
    .toHaveBeenCalledWith('UpdateKnowYourCustomerRefreshJobTrigger.v1', { defer: true, body: { application_name: 'Test Application', triggerName: 'Test Trigger', status: 'RESET' } });
});
